  ...
  render() {
    ...
    const displayShowtimes = () => {
      if (showtimes === undefined)
        ...
        return <h2 style={{ color: "red" }}>Không có suất chiếu</h2>
      else
          ...
          <div className="content-film-container row" style={{ top: "10rem" }}>
            <div className="row col-12">
              ...
              <div className="col-12 col-md-7 col-lg">
                <p className="title-conent" style={{ color: "black", fontSize: "2.5rem", position: "relative", marginBottom: "3rem" }}>Chọn phim :
              ...
              <div className="col-12 col-md-6 col-lg">
                ...
                {this.state.film !== "" ? displayCinema() : (<h2 style={{ color: "red" }}>Vui lòng chọn phim trước</h2>)}
              </div>
              ...
              <div className="col-12 col-md" style={{ position: "relative" }}>
                ...
                <div style={{ position: "relative", top: "1rem", left: "-1rem" }} className="row col-12">
                  {this.state.cinema !== "" ? displayShowtimes() : (<h2 style={{ color: "red" }}>Vui lòng chọn rạp trước</h2>)}
                </div>
              </div>
            </div>
          </div>
